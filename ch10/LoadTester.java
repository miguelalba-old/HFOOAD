...
public class LoadTester {
	...
	public static void main(String[] args) {
		...
		try {
			...
			Subway objectville = loader.loadFromFile(new File(
			...
			System.out.println("\nTesting connections...");
			if (objectville.hasConnection("DRY Drive", "Head First Theater",
					"Meyer Line")
					&& objectville.hasConnection("LSP Lane",
							"JavaBeans Boulevard", "Booch Line")
					&& objectville.hasConnection("OOA&D Oval",
							"Head First Labs", "Gamma Line")) {
